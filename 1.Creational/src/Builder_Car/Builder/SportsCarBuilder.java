package Builder_Car.Builder;

import Builder_Car.Car;
import Builder_Car.CarBuilder;
...
public class SportsCarBuilder implements CarBuilder {
    ...
    public void buildBodyStyle() {
        car.setBodyStyle("External dimensions: overall length (inches): 192.3," + " overall width (inches): 75.5, overall height (inches): 54.2, wheelbase (inches): 12.3," + " front track (inches): 63.7, rear track (inches): 64.1 and curb to curb turning circle (feet): 37.7");
    }
    @Override
